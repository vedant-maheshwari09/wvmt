      ...
      <div className="relative z-20 max-w-6xl mx-auto px-4 sm:px-6 pb-20">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <div className={`mb-6 sm:mb-8 backdrop-blur-xl border rounded-2xl p-1 sm:p-2 ${
            ...
            <TabsList className={`flex w-full overflow-x-auto scrollbar-hide !bg-transparent`}>
              {['home', 'about', 'schedule', 'registration', 'logistics', 'archive', 'contact'].map((tab) => (
                <TabsTrigger 
                  key={tab}
                  value={tab} 
                  className={`flex-shrink-0 font-medium sm:font-semibold data-[state=active]:bg-gradient-to-r data-[state=active]:from-orange-500 data-[state=active]:to-yellow-500 data-[state=active]:text-white rounded-lg sm:rounded-xl transition-all py-2 px-3 sm:px-4 text-sm sm:text-base text-center h-[40px] sm:h-[44px] flex items-center justify-center whitespace-nowrap ${
                    isDark 
