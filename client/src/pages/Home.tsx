    ...
    <div className={`min-h-screen relative overflow-hidden transition-all duration-1000 ${
      ...
      <div className="relative z-20 max-w-6xl mx-auto px-4 sm:px-6 pb-20">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className={`flex w-full mb-6 sm:mb-8 backdrop-blur-xl border rounded-2xl p-2 ${
            isDark 
            ...
            {['home', 'about', 'schedule', 'registration', 'logistics', 'archive', 'contact'].map((tab) => (
              <TabsTrigger 
                key={tab}
                value={tab} 
                className={`flex-1 font-semibold data-[state=active]:bg-gradient-to-r data-[state=active]:from-orange-500 data-[state=active]:to-yellow-500 data-[state=active]:text-white rounded-xl transition-all py-2 px-1 text-sm sm:text-base text-center min-h-[44px] flex items-center justify-center ${
                  isDark 
