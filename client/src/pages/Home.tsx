...
export default function Home() {
  ...
  const scheduleItems = [
    { time: "9:30 - 10:15", title: "Registration", description: "Check in students, pay registration fees, bring pencils/pens (scratch paper provided)", color: "bg-blue-500" },
    { time: "10:15 - 10:30", title: "Welcome Announcement", description: "Opening announcements and enter classrooms", color: "bg-purple-500" },
    { time: "10:30 - 11:30", title: "Individual Round", description: "Test personal mathematical skills and problem-solving", color: "bg-green-500" },
    { time: "11:30 - 11:45", title: "Break", description: "Parents/coaches please stay out of competition rooms during rounds", color: "bg-gray-400" },
    { time: "11:45 - 12:30", title: "Team Round", description: "Collaborative problem-solving with your team", color: "bg-amber-500" },
    { time: "12:30 - 1:30", title: "Lunch", description: "Pizza, chips, and water provided for all participants", color: "bg-orange-500" },
    { time: "1:45 - 2:45", title: "Buzzer Round", description: "Fast-paced elimination bracket where teams compete head-to-head", color: "bg-red-500" },
    { time: "2:45 - 3:00", title: "Break", description: "Preparation for awards ceremony", color: "bg-gray-400" },
    { time: "3:00 - 3:30", title: "Awards Ceremony and Cleanup", description: "Celebrating our winners and tournament wrap-up", color: "bg-blue-500" }
  ];
    ...
    <div className={`min-h-screen relative overflow-hidden transition-all duration-1000 ${
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        {isDark ? (
          ...
          <>
            {/* Light version - subtle background symbols with better spacing */}
            {/* Top row - spread out */}
            <div className="absolute top-12 left-[5%] text-3xl text-orange-600/25 animate-float-slow" style={{ fontFamily: 'Outfit, sans-serif' }}>π</div>
            <div className="absolute top-16 left-[20%] text-4xl text-green-600/25 animate-float" style={{ fontFamily: 'Outfit, sans-serif' }}>∑</div>
            <div className="absolute top-20 left-[40%] text-3xl text-purple-600/25 animate-float-slow" style={{ fontFamily: 'Outfit, sans-serif' }}>δ</div>
            <div className="absolute top-14 left-[60%] text-4xl text-red-600/25 animate-float" style={{ fontFamily: 'Outfit, sans-serif' }}>∫</div>
            <div className="absolute top-18 left-[80%] text-3xl text-cyan-600/25 animate-float-slow" style={{ fontFamily: 'Outfit, sans-serif' }}>√</div>
            
            {/* Second row - avoid center content area */}
            <div className="absolute top-[25%] left-[8%] text-4xl text-pink-600/25 animate-float" style={{ fontFamily: 'Outfit, sans-serif' }}>μ</div>
            <div className="absolute top-[28%] left-[25%] text-3xl text-indigo-600/25 animate-float-slow" style={{ fontFamily: 'Outfit, sans-serif' }}>ω</div>
            <div className="absolute top-[22%] left-[75%] text-4xl text-emerald-600/25 animate-float" style={{ fontFamily: 'Outfit, sans-serif' }}>λ</div>
            <div className="absolute top-[26%] left-[90%] text-3xl text-rose-600/25 animate-float-slow" style={{ fontFamily: 'Outfit, sans-serif' }}>θ</div>
            
            {/* Third row - minimal in center */}
            <div className="absolute top-[40%] left-[3%] text-3xl text-amber-600/25 animate-float-slow" style={{ fontFamily: 'Outfit, sans-serif' }}>σ</div>
            <div className="absolute top-[38%] left-[85%] text-4xl text-teal-600/25 animate-float" style={{ fontFamily: 'Outfit, sans-serif' }}>τ</div>
            <div className="absolute top-[45%] left-[92%] text-3xl text-violet-600/25 animate-float-slow" style={{ fontFamily: 'Outfit, sans-serif' }}>ε</div>
            
            {/* Fourth row - spread wide */}
            <div className="absolute top-[55%] left-[6%] text-4xl text-sky-600/25 animate-float" style={{ fontFamily: 'Outfit, sans-serif' }}>η</div>
            <div className="absolute top-[58%] left-[25%] text-3xl text-fuchsia-600/25 animate-float-slow" style={{ fontFamily: 'Outfit, sans-serif' }}>ρ</div>
            <div className="absolute top-[52%] left-[70%] text-4xl text-orange-600/25 animate-float" style={{ fontFamily: 'Outfit, sans-serif' }}>ξ</div>
            <div className="absolute top-[56%] left-[88%] text-3xl text-green-600/25 animate-float-slow" style={{ fontFamily: 'Outfit, sans-serif' }}>χ</div>
            
            {/* Fifth row - lower area */}
            <div className="absolute top-[70%] left-[12%] text-3xl text-red-600/25 animate-float-slow" style={{ fontFamily: 'Outfit, sans-serif' }}>ν</div>
            <div className="absolute top-[68%] left-[35%] text-4xl text-cyan-600/25 animate-float" style={{ fontFamily: 'Outfit, sans-serif' }}>ι</div>
            <div className="absolute top-[72%] left-[65%] text-3xl text-yellow-600/25 animate-float-slow" style={{ fontFamily: 'Outfit, sans-serif' }}>∞</div>
            <div className="absolute top-[74%] left-[85%] text-4xl text-pink-600/25 animate-float" style={{ fontFamily: 'Outfit, sans-serif' }}>∂</div>
            
            {/* Bottom row - widely spaced */}
            <div className="absolute bottom-20 left-[10%] text-3xl text-indigo-600/25 animate-float" style={{ fontFamily: 'Outfit, sans-serif' }}>Δ</div>
            <div className="absolute bottom-16 left-[35%] text-4xl text-emerald-600/25 animate-float-slow" style={{ fontFamily: 'Outfit, sans-serif' }}>φ</div>
            <div className="absolute bottom-24 left-[65%] text-3xl text-rose-600/25 animate-float" style={{ fontFamily: 'Outfit, sans-serif' }}>α</div>
            <div className="absolute bottom-18 left-[90%] text-4xl text-blue-600/25 animate-float-slow" style={{ fontFamily: 'Outfit, sans-serif' }}>β</div>
            
            {/* Sparse additional symbols - avoiding overlap */}
            <div className="absolute top-[32%] left-[15%] text-3xl text-violet-600/25 animate-float" style={{ fontFamily: 'Outfit, sans-serif' }}>∈</div>
            <div className="absolute top-[48%] left-[15%] text-3xl text-sky-600/25 animate-float-slow" style={{ fontFamily: 'Outfit, sans-serif' }}>≠</div>
            <div className="absolute top-[78%] left-[45%] text-4xl text-fuchsia-600/25 animate-float" style={{ fontFamily: 'Outfit, sans-serif' }}>≤</div>
          </>
        )}
      </div>
      ...
      <div className="relative z-20 max-w-6xl mx-auto px-4 sm:px-6 pb-20">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <div className={`mb-6 sm:mb-8 backdrop-blur-xl border rounded-2xl p-1 sm:p-2 ${
            isDark 
              ? 'bg-gray-800 border-gray-600' 
              : 'bg-white/80 border-gray-200 shadow-lg'
          }`} style={{ marginLeft: '0', marginRight: '0' }}>
            <TabsList ref={tabsListRef} className={`flex w-full overflow-x-auto overflow-y-hidden scrollbar-hide !bg-transparent pl-24 pr-12`}>
              {['home', 'about', 'schedule', 'registration', 'logistics', 'archive', 'contact'].map((tab) => (
                <TabsTrigger 
                  key={tab}
                  value={tab} 
                  className={`flex-shrink-0 font-medium sm:font-semibold data-[state=active]:bg-gradient-to-r data-[state=active]:from-orange-500 data-[state=active]:to-yellow-500 data-[state=active]:text-white rounded-lg sm:rounded-xl transition-all py-2 px-2 sm:px-4 text-xs md:text-sm lg:text-base text-center h-[40px] sm:h-[44px] flex items-center justify-center whitespace-nowrap min-w-[60px] md:min-w-[70px] lg:min-w-[85px] ${
                    isDark 
            ...
            <div className={`backdrop-blur-xl border rounded-3xl p-8 shadow-xl ${
              ...
              <div className="space-y-4">
                {scheduleItems.map((item, index) => {
                  return (
                    <div key={index} className={`flex items-center space-x-4 p-4 backdrop-blur-sm rounded-2xl border ${
                      isDark ? 'bg-white/5 border-white/10' : 'bg-gray-50/80 border-gray-200'
                    }`}>
                      <div className="flex-shrink-0">
                        <div className={`${item.color} text-white px-4 py-3 rounded-xl font-bold text-center text-sm min-w-[140px]`}>
                          {item.time}
                        </div>
                      </div>
                      <div className="flex-1 min-w-0">
                        ...
                        <p className={`break-words ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>{item.description}</p>
                      </div>
                    </div>
                  );
                })}
          ...
          <TabsContent value="registration" className="space-y-8">
            ...
            <div className={`backdrop-blur-xl border rounded-3xl p-6 sm:p-8 shadow-xl text-center ${
              ...
              <div className="bg-gradient-to-r from-purple-500/20 to-cyan-500/20 backdrop-blur-sm rounded-2xl p-4 sm:p-8 mb-8 border border-white/10">
                <Button asChild className="bg-gradient-to-r from-purple-500 to-cyan-500 hover:from-purple-600 hover:to-cyan-600 text-white font-bold py-3 sm:py-4 px-6 sm:px-12 rounded-2xl text-lg sm:text-xl shadow-lg hover:scale-105 transition-all duration-300 w-full sm:w-auto">
                  <a href="https://tinyurl.com/wvmt2025" target="_blank" rel="noopener noreferrer">
                    <ExternalLink className="mr-2 h-4 w-4 sm:h-5 sm:w-5" />
                    <span className="text-sm sm:text-base">Register at tinyurl.com/wvmt2025</span>
                  </a>
                </Button>
              </div>
            </div>
