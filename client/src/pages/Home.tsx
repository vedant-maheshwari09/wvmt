            ...
            <TabsList ref={tabsListRef} className={`flex w-full overflow-x-auto overflow-y-hidden scrollbar-hide !bg-transparent pl-24 pr-12`}>
              {['home', 'about', 'schedule', 'registration', 'logistics', 'archive', 'contact'].map((tab) => (
                <TabsTrigger 
                  key={tab}
                  value={tab} 
                  className={`flex-shrink-0 font-medium sm:font-semibold data-[state=active]:bg-gradient-to-r data-[state=active]:from-orange-500 data-[state=active]:to-yellow-500 data-[state=active]:text-white rounded-lg sm:rounded-xl transition-all py-2 px-1 sm:px-4 text-[10px] sm:text-xs md:text-sm lg:text-base text-center h-[40px] sm:h-[44px] flex items-center justify-center whitespace-nowrap min-w-[50px] sm:min-w-[60px] md:min-w-[70px] lg:min-w-[85px] ${
                    isDark 
          ...
          <TabsContent value="registration" className="space-y-8">
            ...
            <div className={`backdrop-blur-xl border rounded-3xl p-6 sm:p-8 shadow-xl text-center ${
              ...
              <div className="bg-gradient-to-r from-purple-500/20 to-cyan-500/20 backdrop-blur-sm rounded-2xl p-4 sm:p-8 mb-8 border border-white/10">
                <Button asChild className="bg-gradient-to-r from-purple-500 to-cyan-500 hover:from-purple-600 hover:to-cyan-600 text-white font-bold py-3 sm:py-4 px-8 sm:px-16 rounded-2xl text-lg sm:text-xl shadow-lg hover:scale-105 transition-all duration-300 w-full sm:w-auto">
                  <a href="https://tinyurl.com/wvmt2025" target="_blank" rel="noopener noreferrer">
