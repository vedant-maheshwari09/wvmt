        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="text-white">
              <h1 className="font-display text-lg">WVMT</h1>
        ...
        {isOpen && (
          <div className="md:hidden bg-wolverine-blue border-t border-blue-700">
            <div className="px-2 pt-2 pb-3 space-y-2">
              <button 
                onClick={() => scrollToSection('home')}
                className="block w-full text-left px-4 py-3 text-white hover:text-wolverine-gold transition-colors duration-200 rounded-lg hover:bg-blue-700/30 font-medium"
              >
                Home
              </button>
              <button 
                onClick={() => scrollToSection('about')}
                className="block w-full text-left px-4 py-3 text-blue-200 hover:text-white transition-colors duration-200 rounded-lg hover:bg-blue-700/30 font-medium"
              >
                About
              </button>
              <button 
