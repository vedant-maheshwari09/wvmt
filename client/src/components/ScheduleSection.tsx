        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-xl">
          <div className="space-y-6">
            {scheduleItems.map((item, index) => {
              ...
              return (
                <div key={index} className={`flex items-start space-x-6 p-4 ${bgClass} rounded-2xl`}>
                  <div className={`${item.color} ${colorClass} px-4 py-2 rounded-xl font-bold min-w-[140px] text-center`}>
                    {item.time}
                  </div>
                  <div>
